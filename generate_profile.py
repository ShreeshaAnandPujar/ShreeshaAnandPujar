...
INFO = [
    ("__header__", "shreesha anand pujar", ""),
    ("__rule__", "", ""),
    ("Role",     "AI/ML Engineer & Cyber Security Specialist", "val"),
    ("Edu",      "Bachelor's Of Engineering @ APSCE", "val"),
    ("Focus",    "AI/ML Engineering · Cyber Security · Ethical Hacking", "accent"),
    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),
    ("Lang",     "Python · JavaScript · SQL · HTML · CSS", "val"),
    ("AI/ML",    "Generative AI · Computer Vision · Machine Learning", "val"),
    ("Sec",      "Ethical Hacking · Cybersecurity · VAPT", "val"),
    ("Cloud",    "Oracle Cloud Infrastructure (OCI)", "val"),
    ("__blank__", "", ""),
    ("__section__", "~/projects", ""),
    ("EchoFree", "AI hearing aid with real-time noise suppression", "warn"),
    ("",         "speech enhancement + personalized calibration", "muted"),
    ("EcoIntel", "Sustainable Device Lifecycle Intelligence System", "warn"),
    ("TamarindSim", "AI/robotics tamarind seed extraction simulation", "warn"),
    ("__blank__", "", ""),
    ("__section__", "~/highlights", ""),
    ("Award",    "Megahertz Awards", "val"),
    ("Award",    "Student Achiever for Academic Excellence", "val"),
    ("__stats__", "", ""),
    ("__blank__", "", ""),
    ("__section__", "~/reach", ""),
    ("Web",      "shreeshaanandpujar.carrd.co", "accent"),
    ("In",       "linkedin.com/in/shreesha-anand-pujar-ba1b96369", "accent"),
    ("Mail",     "shreeshaanandp@gmail.com", "accent"),
]
...
def fetch_stats():
    ...
    try:
        ...
        user = json.load(urllib.request.urlopen(req, **kwargs))
        ...
        while page <= 5:
            ...
            repos = json.load(urllib.request.urlopen(req, **kwargs))
            if not repos:
                break
...
def render(theme_name, colors, stats, ist_now):
    ...
    parts.append(
        ...
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8">open to AI/ML &amp; Cyber Security roles</tspan>'
